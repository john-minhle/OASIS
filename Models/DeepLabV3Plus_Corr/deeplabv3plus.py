import Models.DeepLabV3Plus_Corr.resnet as resnet 
...
class DeepLabV3Plus(nn.Module):
    def __init__(self, cfg):
        ...
        self.backbone = \
                resnet.__dict__['resnet101'](True, multi_grid=False,
                                                 replace_stride_with_dilation=[False, True, True])

        low_channels = 256
        high_channels = 2048

        self.head = ASPPModule(high_channels, [12, 24, 36])
